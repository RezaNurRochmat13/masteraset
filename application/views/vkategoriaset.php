...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('hardware/getHardware');?>"><i class="glyphicon glyphicon-th-list"></i>Kategori Aset</a></li>
        <li class="active">Lihat Kategori</li>
      </ol>
    </section>
  ...
  <div class="panel-heading"><b>Data Kategori Aset</b></div>
  <div class="panel-body">
      <a href="<?php echo site_url('tambahKategori/tambahKategori')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Kategori Aset</a>
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr>
          <td><?php echo $no++?></td>
          <td><?php echo $data->kode_kategori_aset?></td>
          <td><?php echo $data->nama_kategori_aset?></td>
          <td>
           <?php echo anchor('tambahKategori/edit/'.$data->kode_kategori_aset,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
           <?php echo anchor('tambahKategori/delete/'.$data->kode_kategori_aset,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
