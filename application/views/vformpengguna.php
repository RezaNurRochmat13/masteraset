         ...
         <tr>
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-pencil"></i><input type="text" name="username" class="form-control" value="<?php echo set_value('username')?>">
                  </div>
            </div>
          </div>
            </td>
          ...
          <td>
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-pencil"></i><input type="password" name="password" class="form-control" value="<?php echo set_value('password')?>">
                  </div>
            </div>
          </div>
            </td>
