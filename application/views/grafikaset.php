...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-signal"></i>Filter Grafik Aset</a></li>
  ...
  <div class="col-xs-3">
    <div class="form-group">
      <form id="form">
       <select class="selectpicker form-control" name="tanggal_perolehan" id="kategori" required>
                        <?php 
                          foreach ($year as $key) { ?>
  ...
  <a href="javascript:void(0)" onclick="submit()" class="btn btn-primary">Submit</a>
</div>
        <?php 
...
function submit()
{
    $.ajax({
     ...
     for(i=0;i<data.length;i++) { 
      key[i] = data[i].year;
     name[i] = data[i].nama_kategori_aset; 
