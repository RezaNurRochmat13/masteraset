...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Update Kategori Aset</b></div>
  <div class="panel-body">
     <?php foreach ($edit_kategori as $u) { { ?>
     <form action="<?php echo base_url(). 'index.php/tambahKategori/update';?>" method="post">
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                       <input type="hidden" name="kode_kategori_aset" value="<?php echo $u->kode_kategori_aset ?>">
                      <i class="glyphicon glyphicon-pencil"></i><input type="text" name="nama_kategori_aset" class="form-control" value="<?php echo $u->nama_kategori_aset?>">
                  </div>
            </div>
          </div>
            </td>
