...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-th-list"></i>Penyusutan Aset</a></li>
        <li class="active">Susutkan Data</li>
      </ol>
    </section>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Susut Data Penyusutan Aset</b></div>
  <div class="panel-body">
    <?php echo $this->session->flashdata('msg1')?>    
    <?php foreach ($susut as $u) { ?>
    <form action="<?php echo base_url(). 'index.php/penyusutan/susutkan'; ?>" method="post">
         ...
         <tr>
          ...
          <td>
            <div class="form-group-row">
              <label for="example-text-input" class="col-xs-2 col-form-label">Harga Susut Aset</label>
              <div class="col-xs-10">
                <div class="right-inner-addon">
                    <i class="glyphicon glyphicon-usd"></i><input type="text" name="harga_susut" class="form-control" value="<?php echo $u->harga_susut?>">
                </div>
              </div>
          </div>
          </td>
          ...
          <td>
            <div class="form-group-row">
              <label for="example-text-input" class="col-xs-2 col-form-label">Tanggal Susut Aset</label>
              <div class="col-xs-10">
                <div class="right-inner-addon">
                     <i class="glyphicon glyphicon-calendar"></i><input type="text" name="tanggal_susut" id="datepicker" class="form-control" value="<?php echo $u->tanggal_susut?>">
                   </div>
                </div>
            </div>
          </td>
