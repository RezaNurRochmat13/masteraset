...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Transaksi Aset
        <small>Registrasi Aset</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url('software/getSoftware');?>"><i class="glyphicon glyphicon-th-list"></i>Registrasi Aset</a>
        </li>
  ...
  <div class="panel-heading"><b>Data Registrasi Aset</b></div>
  <div class="panel-body">
    <div class="col-md-7">
     <a href="<?php echo site_url('perencanaan/tambahData')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Data Aset</a>
   </div>
     <form action="<?php echo site_url('perencanaan/cariData');?>" method = "post">
       ...
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr height="50px">
          ...
          <td width="100px"><?php echo date("d F Y",strtotime($data->tanggal_perolehan)); ?></td>
          <td width="100px"><?php echo $rp ="Rp".number_format($data->harga_perolehan,2,',','.')?></td>
          <td width="100px"><?php echo $data->nama_kategori_aset?></td>
          <td width="100px"><?php echo $data->nama_status_aset?></td>
          <td width="250px">
           <?php echo anchor('perencanaan/edit/'.$data->kode_aset,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Edit Data</button>');?>
           <?php echo anchor('perencanaan/delete/'.$data->kode_aset,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Data</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
