...
<div class="wrapper">
  ...
  <div class="panel-body">
     <div class="col-md-7">
     <a href="<?php echo site_url('user/tambahData')?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-plus"></i>Tambah Data User</a>
   </div>
       <table class="table table-striped">
        ...
        <?php }else{
         ...
         <tr>
          ...
          <td>
            <?php echo anchor('user/edit/'.$data->id_user,'<button type="button" class="btn btn-info"><i class="glyphicon glyphicon-pencil"></i>Ubah Password</button>');?>
           <?php echo anchor('user/delete/'.$data->id_user,'<button type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>Hapus Pengguna</button>');?>
          </td>
         </tr>
        <?php }}?>
        </tbody>
