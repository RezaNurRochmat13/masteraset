...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="glyphicon glyphicon-user"></i>Data Pengguna</a></li>
...
<div class="panel panel-default">
            ...
            <div class="form-group-row">
                ...
                <div class="col-xs-10">
                  <div class="right-inner-addon">
                      ...
                      <i class="glyphicon glyphicon-pencil"></i><input type="text" name="username" class="form-control" value="<?php echo $u->username?>">
                  </div>
            </div>
          </div>
            </td>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Powered By &copy; 2015 <a href="#">Aino System Integration</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
