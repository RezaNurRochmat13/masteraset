  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Registrasi Ulang Data</li>
      </ol>
    </section>
...
<div class="panel panel-default">
  <div class="panel-heading"><b>Form Registrasi Ulang Data Penyusutan Aset</b></div>
  <div class="panel-body">
    <?php echo $this->session->flashdata('msg1')?>    
    <?php foreach ($edit as $u) { ?>
    <form action="<?php echo base_url(). 'index.php/penyusutan/update'; ?>" method="post">
